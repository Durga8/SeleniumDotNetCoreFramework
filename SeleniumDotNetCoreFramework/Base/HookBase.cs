...
using static SeleniumDotNetCoreFramework.Base.DriverSetUp;
   ...
   public  class HookBase:ExcelHelpers
    {
        ...
        {
            //IWebElement sourceElement = driver.FindElement(srcElement);
            //IWebElement destinationElement= driver.FindElement(dstElement);
